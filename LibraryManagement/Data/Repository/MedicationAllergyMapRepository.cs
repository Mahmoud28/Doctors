...
{
    public class MedicationAllergyMapRepository : Repository<MedicationAllergyMap>, IMedicationAllergyMapRepository
    {
        private readonly IMapper _mapper;
        public MedicationAllergyMapRepository(LibraryDbContext context,IMapper mapper) : base(context)
        {
            _mapper = mapper;
        }

        public MedicationAllergyMap GetById(int id)
        {

            var MedicationAllergyMap = _context.Set<MedicationAllergyMap>().Where(d => d.Id == id).FirstOrDefault();
            return MedicationAllergyMap;
        }

     


        ////Get All MedicationAllergyMaps
        //public PagingList<MedicationAllergyMap> GetAllMedicationAllergyMaps(pagination pagination, sort sort, string search, string search_operator, string filter)
        //{
        //    dynamic searchFilter = string.Empty;
        //    var operater = string.IsNullOrEmpty(search_operator) ? null : JObject.Parse(search_operator);
        //    IQueryable<MedicationAllergyMap> query = _context.Set<MedicationAllergyMap>();
        ...
        //                            break;
        //                        default:
        //                            var tempQuery = _context.Set<MedicationAllergyMap>();
        //                            query = count == 0 ? query.Where<MedicationAllergyMap>(
        //                                (object)_filter.Key, (object)s,
        //                                (WhereOperation)StringEnum.Parse(typeof(WhereOperation), op)) :
        //                                query.Concat<MedicationAllergyMap>(tempQuery.Where<MedicationAllergyMap>(
        //                                (object)_filter.Key, (object)s,
        //                                (WhereOperation)StringEnum.Parse(typeof(WhereOperation), op)));
        //                            count = count + 1;
        //                            break;
        ...
        //                query = query.Where<MedicationAllergyMap>(
        ...
        //        }
        //    }
        //    query = query.OrderBy<MedicationAllergyMap>(sort.predicate, !sort.reverse ? "asc" : "");


        //    return new PagingList<MedicationAllergyMap>(query, pagination.start / 10, pagination.Count == 0 ? 10 : pagination.Count);
        //}
